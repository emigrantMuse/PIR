package nankai.minioram.client;
...
import nankai.minioram.client.common.Position;
import nankai.minioram.client.common.SlotObject;
import nankai.minioram.common.CommInfo;
import nankai.minioram.common.CommandType;
import nankai.minioram.common.ResponseType;
import nankai.minioram.common.Util;
import nankai.minioram.interfaces.ORAM;
...
public class PartitionClient implements ORAM{
	...
	public boolean init(int nN)
	{
	    ...
	    n_capacity = (int) Math.ceil(n_realBlocks_p);
